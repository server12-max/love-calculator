        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeeformComponent = /** @class */ (function () {
                ...
                EmployeeformComponent.prototype.submit = function (employeeform) {
                    debugger;
                    var fname = employeeform.form.value.name;
                    var sname = employeeform.form.value.position;
                ...
                EmployeeformComponent.prototype.calculate = function (nameOne, nameTwo) {
                    var error = "";
                    ...
                    var data = this.response(percentage);
                    // if (inputOne === "Michael" && inputTwo ==="Omar") {
                    //   percentage = 100; 
                    // }
                };
                EmployeeformComponent.prototype.response = function (percentage) {
                    var responses = [
                        "None. None at all.",
                        "Not much chemistry.",
